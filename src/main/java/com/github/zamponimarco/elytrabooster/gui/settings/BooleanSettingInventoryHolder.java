...
public class BooleanSettingInventoryHolder extends SettingInventoryHolder {
	...
	protected void initializeInventory() {
		...
		registerClickConsumer(12, getBooleanItem(HeadUtils.skullFromValue(TRUE_HEAD), true), getBooleanConsumer(true));
		registerClickConsumer(14, getBooleanItem(HeadUtils.skullFromValue(FALSE_HEAD), false),
