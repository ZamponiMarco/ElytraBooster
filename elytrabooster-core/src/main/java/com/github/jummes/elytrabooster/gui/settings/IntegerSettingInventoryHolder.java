...
public class IntegerSettingInventoryHolder extends SettingInventoryHolder {
	...
	protected void initializeInventory() {
		...
		registerClickConsumer(11, getModifyItem(-1, ElytraBooster.getInstance().getWrapper().skullFromValue(ARROW_LEFT_HEAD)),
				getConsumer(-1));
		registerClickConsumer(10, getModifyItem(-10, ElytraBooster.getInstance().getWrapper().skullFromValue(ARROW2_LEFT_HEAD)),
				getConsumer(-10));
		registerClickConsumer(9, getModifyItem(-100, ElytraBooster.getInstance().getWrapper().skullFromValue(ARROW3_LEFT_HEAD)),
				getConsumer(-100));
		registerClickConsumer(15, getModifyItem(+1, ElytraBooster.getInstance().getWrapper().skullFromValue(ARROW_RIGHT_HEAD)),
				getConsumer(+1));
		registerClickConsumer(16, getModifyItem(+10, ElytraBooster.getInstance().getWrapper().skullFromValue(ARROW2_RIGHT_HEAD)),
				getConsumer(+10));
		registerClickConsumer(17, getModifyItem(+100, ElytraBooster.getInstance().getWrapper().skullFromValue(ARROW3_RIGHT_HEAD)),
				getConsumer(+100));
