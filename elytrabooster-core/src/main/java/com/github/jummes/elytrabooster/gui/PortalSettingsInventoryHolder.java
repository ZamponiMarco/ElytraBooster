...
import com.github.jummes.elytrabooster.gui.settings.BooleanSettingInventoryHolder;
import com.github.jummes.elytrabooster.gui.settings.DoubleSettingInventoryHolder;
import com.github.jummes.elytrabooster.gui.settings.IntegerSettingInventoryHolder;
import com.github.jummes.elytrabooster.gui.settings.StringSettingInventoryHolder;
import com.github.jummes.elytrabooster.gui.settings.enums.AxisEnumSettingInventoryHolder;
import com.github.jummes.elytrabooster.gui.settings.enums.ShapeEnumSettingInventoryHolder;
import com.github.jummes.elytrabooster.gui.settings.enums.SorterEnumSettingInventoryHolder;
import com.github.jummes.elytrabooster.gui.settings.enums.TrailEnumSettingInventoryHolder;
...
public class PortalSettingsInventoryHolder extends ElytraBoosterInventoryHolder {
	...
	protected void initializeInventory() {
		...
		registerClickConsumer(2,
				getPortalSetting(ElytraBooster.getInstance().getWrapper().skullFromValue(IS_BLOCK_OUTLINE_HEAD), "isBlockOutline",
		...
		registerClickConsumer(3,
				getPortalSetting(ElytraBooster.getInstance().getWrapper().skullFromValue(OUTLINE_TYPE_HEAD), "outlineType",
		...
		registerClickConsumer(5,
				getPortalSetting(ElytraBooster.getInstance().getWrapper().skullFromValue(COOLDOWN_TYPE_HEAD), "cooldownType",
		...
		registerClickConsumer(6,
				getPortalSetting(ElytraBooster.getInstance().getWrapper().skullFromValue(COOLDOWN_HEAD), "cooldown", portal.getCooldown()),
		...
		registerClickConsumer(12,
				getPortalSetting(ElytraBooster.getInstance().getWrapper().skullFromValue(INITIAL_VELOCITY_HEAD), "initialVelocity",
		...
		registerClickConsumer(13,
				getPortalSetting(ElytraBooster.getInstance().getWrapper().skullFromValue(FINAL_VELOCITY_HEAD), "finalVelocity",
		...
		registerClickConsumer(14,
				getPortalSetting(ElytraBooster.getInstance().getWrapper().skullFromValue(BOOST_DURATION_HEAD), "boostDuration",
						portal.getBoost().getBoostDuration()),
				getSettingConsumer(manager, section, "boostDuration", portal.getBoost().getBoostDuration(),
						IntegerSettingInventoryHolder.class));
		registerClickConsumer(21, getPortalSetting(ElytraBooster.getInstance().getWrapper().skullFromValue(AXIS_HEAD), "axis", portal.getAxis()),
				getSettingConsumer(manager, section, "axis", portal.getAxis(), AxisEnumSettingInventoryHolder.class));
		registerClickConsumer(22, getPortalSetting(ElytraBooster.getInstance().getWrapper().skullFromValue(SHAPE_HEAD), "shape", portal.getShape()),
				getSettingConsumer(manager, section, "shape", portal.getShape(),
						ShapeEnumSettingInventoryHolder.class));
		registerClickConsumer(23,
				getPortalSetting(ElytraBooster.getInstance().getWrapper().skullFromValue(MEASURES_HEAD), "measures", portal.getMeasures()),
				getSettingConsumer(manager, section, "measures", portal.getMeasures(),
						StringSettingInventoryHolder.class));
		registerClickConsumer(8,
				getPortalSetting(ElytraBooster.getInstance().getWrapper().skullFromValue(TRAIL_HEAD), "trail", portal.getBoost().getTrail().getName()),
		...
		registerClickConsumer(17,
				getPortalSetting(ElytraBooster.getInstance().getWrapper().skullFromValue(SORTER_HEAD), "sorter", portal.getSorter().getName()),
