...
public class EntityHolder implements Model {
    ...
    @Serializable(headTexture = DESCRIPTION_HEAD, description = "gui.spawner.entityHolder.entityDescription.description", additionalDescription = {"gui.additional-tooltips.recreate"})
