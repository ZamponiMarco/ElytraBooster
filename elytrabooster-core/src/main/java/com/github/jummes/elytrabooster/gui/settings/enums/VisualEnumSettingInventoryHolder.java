...
public class VisualEnumSettingInventoryHolder extends EnumSettingInventoryHolder {
	...
	public VisualEnumSettingInventoryHolder(BoosterManager<?> manager, ConfigurationSection section, String key, Object value,
	...
	public void setUpMap() {
		headsMap.put("flame", ElytraBooster.getInstance().getWrapper().skullFromValue(FLAME_HEAD));
		headsMap.put("firework", ElytraBooster.getInstance().getWrapper().skullFromValue(FIREWORK_HEAD));
	}
