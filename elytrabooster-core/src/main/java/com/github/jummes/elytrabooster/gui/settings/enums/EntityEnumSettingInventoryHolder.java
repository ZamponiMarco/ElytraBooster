...
public class EntityEnumSettingInventoryHolder extends EnumSettingInventoryHolder{
	...
	public void setUpMap() {
		...
		headsMap.put("mushroom", ElytraBooster.getInstance().getWrapper().skullFromValue(MUSHROOM_HEAD));
		headsMap.put("potion", ElytraBooster.getInstance().getWrapper().skullFromValue(POTION_HEAD));
	}
