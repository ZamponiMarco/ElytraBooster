...
public class StringSettingInventoryHolder extends SettingInventoryHolder implements Listener {
	...
	protected void initializeInventory() {
		this.inventory = Bukkit.createInventory(this, 27,
				MessageUtils.color(isCreation ? "&6&lCreate a booster" : "&6&lModify &e&l" + key));
		registerClickConsumer(13, getStringItem(ElytraBooster.getInstance().getWrapper().skullFromValue(MODIFY_HEAD)), e -> playerCanWrite());
	...
	private ItemStack getStringItem(ItemStack item) {
		...
		meta.setDisplayName(MessageUtils.color(isCreation ? "&6&lCreate a booster" : "&6&lModify Value"));
