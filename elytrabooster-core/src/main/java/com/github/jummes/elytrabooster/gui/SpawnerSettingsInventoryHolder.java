...
import com.github.jummes.elytrabooster.gui.settings.enums.EntityEnumSettingInventoryHolder;
...
public class SpawnerSettingsInventoryHolder extends ElytraBoosterInventoryHolder {
	...
	protected void initializeInventory() {
		...
		registerClickConsumer(2,
				getSpawnerSetting(ElytraBooster.getInstance().getWrapper().skullFromValue(MIN_RADIUS_HEAD), "minRadius", spawner.getMinRadius()),
		...
		registerClickConsumer(3,
				getSpawnerSetting(ElytraBooster.getInstance().getWrapper().skullFromValue(MAX_RADIUS_HEAD), "maxRadius", spawner.getMaxRadius()),
				getSettingConsumer(manager, section, "maxRadius", spawner.getMaxRadius(),
						DoubleSettingInventoryHolder.class));
		registerClickConsumer(5,
				getSpawnerSetting(ElytraBooster.getInstance().getWrapper().skullFromValue(COOLDOWN_HEAD), "cooldown", spawner.getCooldown()),
		...
		registerClickConsumer(6,
				getSpawnerSetting(ElytraBooster.getInstance().getWrapper().skullFromValue(MAX_ENTITIES_HEAD), "maxEntities",
		...
		registerClickConsumer(12,
				getSpawnerSetting(ElytraBooster.getInstance().getWrapper().skullFromValue(INITIAL_VELOCITY_HEAD), "initialVelocity",
		...
		registerClickConsumer(13,
				getSpawnerSetting(ElytraBooster.getInstance().getWrapper().skullFromValue(FINAL_VELOCITY_HEAD), "finalVelocity",
		...
		registerClickConsumer(14,
				getSpawnerSetting(ElytraBooster.getInstance().getWrapper().skullFromValue(BOOST_DURATION_HEAD), "boostDuration",
		...
		registerClickConsumer(8,
				getSpawnerSetting(ElytraBooster.getInstance().getWrapper().skullFromValue(ENTITY_HEAD), "entity", spawner.getHolder().getEntity()),
		...
		registerClickConsumer(17,
				getSpawnerSetting(ElytraBooster.getInstance().getWrapper().skullFromValue(TRAIL_HEAD), "trail",
