...
public abstract class ElytraBoosterInventoryHolder implements InventoryHolder {
	...
	protected ItemStack getDeleteItem() {
		ItemStack item = ElytraBooster.getInstance().getWrapper().skullFromValue(DELETE_HEAD);
		ItemMeta meta = item.getItemMeta();
	...
	protected ItemStack getCreateItem() {
		ItemStack item = ElytraBooster.getInstance().getWrapper().skullFromValue(CREATE_HEAD);
		ItemMeta meta = item.getItemMeta();
	...
	protected ItemStack getBackItem() {
		ItemStack item = ElytraBooster.getInstance().getWrapper().skullFromValue(BACK_HEAD);
		ItemMeta meta = item.getItemMeta();
