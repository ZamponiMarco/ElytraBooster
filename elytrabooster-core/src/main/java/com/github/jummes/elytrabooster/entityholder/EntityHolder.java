package com.github.jummes.elytrabooster.entityholder;
...
import com.github.jummes.elytrabooster.entity.ActiveEntity;
...
public class EntityHolder implements Model {
    ...
    public EntityHolder(EntityDescription entityDescription, int maxEntities, SimpleBoost boost) {
        ...
        this.boost = boost;
        this.entities = new ArrayList<ActiveEntity>();
    }
